...
SkillPostDao(); MessageDao messageDao = new MessageDao(); List<SkillPost>
  posts = postDao.forUser(user.getId()); List<Message>
    messages = messageDao.forUser(user.getId(), 10); %> <%@ include
        ...
        <div class="grid lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <p class="text-slate-600 mt-4">
              <%= HtmlUtil.escape(user.getBio() == null ? "Share a short
              introduction to tell the community what you love to teach." :
              user.getBio()) %>
            </p>
            <a
            ...
            <div class="border border-slate-100 rounded-2xl p-4 flex gap-4">
              ...
              <div>
                <p class="text-sm text-slate-500">
                  ...
                  "Community member" : message.getSenderName()) %> • <%=
                  HtmlUtil.escape(DateUtil.format(message.getCreatedAt(), "MMM
                  dd, yyyy")) %>
                </p>
